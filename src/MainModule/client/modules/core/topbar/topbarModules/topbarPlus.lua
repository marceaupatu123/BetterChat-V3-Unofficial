...
local IconController = require(script.Parent:WaitForChild("IconController"))
local Signal = require(script.Parent:WaitForChild("Signal"))
local Maid = require(script.Parent:WaitForChild("Maid"))
local TopbarPlusGui = require(script.Parent:WaitForChild("TopbarPlusGui"))
local TopbarPlusReference = require(script.Parent:WaitForChild("TopbarPlusReference"))
